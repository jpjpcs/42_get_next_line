...
// Line 15 - Copy characters from stash to the line
...
//
//Inside function:
// Line 1 - Remaining data after the newline character
// Line 6 - Find the newline character
// Line 8 - If newline character is not found
// Line 12 - Allocate memory for the remaining stash after the newline character
// Line 16 - Copy remaining characters from stash to the new string
// Line 18 - Null-terminate the new string
//
//
//
//GET NEXT LINE
